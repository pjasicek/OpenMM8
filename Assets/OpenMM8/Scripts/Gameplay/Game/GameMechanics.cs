...
namespace Assets.OpenMM8.Scripts.Gameplay
{
    ...
    {
        static public int CalculateSpellDamage(SpellType spellType, SkillMastery skillMastery, int skillLevel, int victimHp)
        {
            ...
            switch (spellType)
            {
                ...
                case SpellType.Earth_MassDistortion:
                    damage = victimHp * (spellData.BaseDamage + 2 * skillLevel) / 100;
                    break;
